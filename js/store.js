...
export const STORE={detail:[],finals:[],next:null,season:[],boxCache:{},liveActive:false,phiForm:null,lastWinProb:null,lastGameCard:null};
export function resetStore(){STORE.detail=[];STORE.finals=[];STORE.next=null;STORE.season=[];STORE.boxCache={};STORE.liveActive=false;STORE.phiForm=null;STORE.lastWinProb=null;STORE.lastGameCard=null;}
